...
public class UIAnimImageColorFade : MonoBehaviour
{
    ...
    public void Update()
    {
        m_targetImage.color = new Color(m_targetImage.color.r, m_targetImage.color.g, m_targetImage.color.b, m_localAnim.Update().w);
    }
